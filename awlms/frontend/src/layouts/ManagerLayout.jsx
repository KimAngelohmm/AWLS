        ...
        <div className="hr-sidebar-foot">
          <div className="hr-sidebar-user">
            ...
            <div className="hr-sidebar-user-info">
              <p className="hr-sidebar-user-name">{user?.full_name ?? 'Manager'}</p>
              <p className="hr-sidebar-user-role">Department Manager</p>
            </div>
            <button
              type="button"
      ...
      <div className="hr-main">
        <header className="hr-topbar">
          <div className="hr-topbar-left">
            <p className="hr-topbar-title">Manager Workspace</p>
